...
for epoch in range(100):
	...
	for (batch) in train_dataloader:
		...
		#comparison to original, calculate gradient - loss
...
#write to file
with open( "threshold3.txt", "w") as file:
...
print("Registers: ")
print(train["rax_delta"].describe())
print(test["rax_delta"].describe())
...
#### Write Results ####
r.to_csv("test3_results.csv", index=False)
